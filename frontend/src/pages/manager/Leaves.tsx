          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-border">
              {loading ? (
                ...
                <tr>
                  <td colSpan={7} className="px-4 py-12 text-center text-gray-400">No leave requests found</td>
                </tr>
              ) : (
                leaves.map((leave) => (
                    ...
                    <td className="px-4 py-3">
                      {leave.status === 'pending' && (
                        <div className="flex items-center gap-2">
                          ...
                          <button onClick={() => setRejectModal(leave)} className="p-1.5 bg-red-500/10 hover:bg-red-100 rounded-lg">
